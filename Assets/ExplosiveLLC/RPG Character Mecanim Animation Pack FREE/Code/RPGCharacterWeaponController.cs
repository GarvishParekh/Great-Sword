...
namespace RPGCharacterAnims
{
    public class RPGCharacterWeaponController : MonoBehaviour
    {
		...
		/// <summary>
		/// Queue a command to sheath the currentX weapon and switch to a new one.
		/// </summary>
        ...
        /// <summary>
        /// Async method to sheath the currentX weapon and switch to a new one.
        /// </summary>
        ...
        /// <summary>
        /// Sync weapon object visibility to the currentX weapons in the RPGCharacterController.
        /// </summary>
        public void SyncWeaponVisibility()
        { coroQueue.Run(_SyncWeaponVisibility()); }

        /// <summary>
        /// Async method to sync weapon object visiblity to the currentX weapons in RPGCharacterController.
